       ...
       $post_title= $row['post_title'];
        $post_con = $row['post_content'];
              ...
              <form action="" method="post" id="f">
                  ...
                  <input type="text" name="title" value="<?php echo $post_title; ?>"size="80" required="required"><br/>
                  <textarea name="content" id="" cols="82" rows="4" ><?php echo $post_con; ?></textarea><br>
